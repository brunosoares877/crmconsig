    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-blue-900 to-blue-800 flex items-center justify-center p-4">
      <div className="w-full max-w-6xl flex items-center justify-between">
        ...
        <div className="flex-shrink-0 w-full lg:w-auto">
          <div className="bg-white rounded-2xl shadow-2xl p-8 w-full lg:w-96">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <Button 
                type="submit" 
                className="w-full h-12 bg-blue-600 hover:bg-blue-700 text-white font-medium rounded-lg shadow-lg text-sm mt-6"
                disabled={isLoading}
              >
                {isLoading ? (
                  <>
              ...
              <Button 
                variant="outline" 
                className="w-full h-12 border-gray-300 rounded-lg hover:bg-gray-50 text-sm" 
