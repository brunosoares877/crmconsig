...
const Login = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-900 via-blue-700 to-blue-500 flex flex-col lg:flex-row overflow-auto">
      ...
      <div className="flex-1 flex items-center justify-center p-4 sm:p-6 lg:p-8 order-2 lg:order-1">
        <div className="text-center text-white max-w-lg w-full">
          <div className="flex items-center justify-center mb-4 sm:mb-6">
            <div className="w-10 h-10 sm:w-12 sm:h-12 bg-white rounded-lg flex items-center justify-center mr-3">
              <div className="w-6 h-6 sm:w-8 sm:h-8 bg-blue-600 rounded-sm"></div>
            </div>
            <h1 className="text-2xl sm:text-3xl font-bold">LeadConsig</h1>
          </div>
          
          <div className="mb-4 sm:mb-6">
            <div className="inline-flex items-center px-3 py-1 sm:px-4 sm:py-2 rounded-full bg-blue-600/20 border border-blue-400/30 text-blue-200 text-xs sm:text-sm font-medium mb-3 sm:mb-4">
              ✨ Novidade
            </div>
      ...
      <div className="flex-1 flex items-center justify-center p-4 sm:p-6 lg:p-8 order-1 lg:order-2">
        <div className="bg-white/95 backdrop-blur-sm rounded-2xl shadow-2xl p-4 sm:p-6 lg:p-8 w-full max-w-md mx-auto max-h-[90vh] overflow-y-auto">
          ...
          <form onSubmit={handleSubmit} className="space-y-3 sm:space-y-4">
              ...
              <>
                <div className="space-y-1">
                  ...
                  <Input 
                    ...
                    type="text" 
                    required 
                    className={`h-10 sm:h-12 rounded-xl border-gray-200 text-sm ${errors.fullName ? "border-red-500" : ""}`}
                    value={fullName} 
                ...
                <div className="space-y-1">
                  ...
                  <Input 
                    ...
                    className={`h-10 sm:h-12 rounded-xl border-gray-200 text-sm ${errors.company ? "border-red-500" : ""}`}
                    value={company} 
                ...
                <div className="space-y-1">
                  ...
                  <Input 
                    ...
                    className={`h-10 sm:h-12 rounded-xl border-gray-200 text-sm ${errors.whatsapp ? "border-red-500" : ""}`}
                    value={whatsapp} 
            ...
            <div className="space-y-1">
              ...
              <Input 
                ...
                required 
                autoComplete="email" 
                className={`h-10 sm:h-12 rounded-xl border-gray-200 text-sm ${errors.email ? "border-red-500" : ""}`}
                value={email} 
            ...
            <div className="space-y-1">
              ...
              <div className="relative">
                <Input 
                  ...
                  className={`h-10 sm:h-12 rounded-xl border-gray-200 pr-12 text-sm ${errors.password ? "border-red-500" : ""}`}
                  value={password} 
              ...
              <div className="space-y-1">
                ...
                <div className="relative">
                  <Input 
                    ...
                    className={`h-10 sm:h-12 rounded-xl border-gray-200 pr-12 text-sm ${errors.confirmPassword ? "border-red-500" : ""}`}
            ...
            <Button 
              type="submit" 
              className="w-full h-10 sm:h-12 bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 text-white font-medium rounded-xl shadow-lg text-sm"
              disabled={isLoading}
            >
              {isLoading ? (
                <>
                  <div className="h-3 w-3 sm:h-4 sm:w-4 mr-2 animate-spin rounded-full border-2 border-t-transparent"></div>
            ...
            <div className="space-y-2 sm:space-y-3">
              <Button 
                variant="outline" 
                className="w-full h-10 sm:h-12 border-gray-200 rounded-xl hover:bg-gray-50 text-xs sm:text-sm" 
              ...
              >
                ...
                <span className="hidden sm:inline">Continuar com o Google</span>
              ...
              <Button 
                ...
                type="button"
              >
                <svg className="mr-2 h-4 w-4 sm:h-5 sm:w-5 text-blue-600" viewBox="0 0 24 24" fill="currentColor">
                  <path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/>
                </svg>
                <span className="hidden sm:inline">Continuar com o Facebook</span>
              ...
              >
                ...
                <span className="hidden sm:inline">Continuar com a Apple</span>
