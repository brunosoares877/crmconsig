...
const MaquinaDeLeads = () => {
  ...
  const loadPdf = async () => {
    try {
      const { data } = await supabase.storage
        .from('courses')
        .getPublicUrl('maquina-de-leads/curso.pdf');
  ...
  if (loading) {
    return (
      <PageLayout title="Máquina de Leads" subtitle="Carregando...">
          ...
          <Card className="border-2 border-green-500 shadow-2xl">
            <div className="bg-gradient-to-r from-green-500 to-emerald-600 text-white p-6 rounded-t-lg">
              ...
              <p className="text-green-50">
                Você tem acesso completo ao curso Máquina de Leads
              </p>
            </div>
        ...
        <div className="max-w-4xl mx-auto px-4 py-6">
            ...
            <div className="relative z-10 p-6 md:p-8">
              <div className="max-w-2xl mx-auto text-center">
                ...
                <h1 className="text-3xl md:text-5xl font-black text-white mb-2 leading-tight">
                  Descubra todas as formas de
                  <span className="block text-yellow-300">CAPTAR CLIENTES</span>
                </h1>
                <p className="text-lg text-white mb-6">
                  e nunca mais fique sem fechar contratos
                </p>
          ...
          <div className="grid md:grid-cols-3 gap-3 mb-4">
            ...
            <Card className="border-2 md:col-span-2">
              <div className="bg-gradient-to-r from-blue-50 to-indigo-50 p-3 border-b">
                <h3 className="text-base font-bold text-gray-900">O Que Você Vai Aprender</h3>
              </div>
          ...
          <Card className="bg-gradient-to-r from-slate-900 to-blue-900 text-white border-0 shadow-2xl">
            <CardContent className="p-5 text-center">
              ...
              <h2 className="text-xl font-bold mb-2">SÓ DEPENDE DE VOCÊ!</h2>
