...
const WhatsAppButton: React.FC<WhatsAppButtonProps> = ({
  ...
  if (variant === "floating") {
    return <a href={whatsappUrl} target="_blank" rel="noopener noreferrer" className="fixed bottom-6 right-6 z-50 bg-green-500 hover:bg-green-600 text-white rounded-full p-4 shadow-lg flex items-center justify-center transition-transform hover:scale-110" aria-label="Contact on WhatsApp">
  ...
  return (
    <Button
      ...
      variant="outline"
      className="gap-2 border-green-500 text-green-500 hover:bg-green-500 hover:text-white"
    >
