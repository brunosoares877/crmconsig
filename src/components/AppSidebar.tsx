...
export function AppSidebar() {
  ...
  return (
    <Sidebar className="bg-gradient-to-br from-blue-900 via-blue-800 to-indigo-900 border-r border-blue-700/50 sidebar-responsive">
      <SidebarHeader className="border-b border-blue-700/50 bg-blue-900/50 p-4">
        <Link to="/dashboard" className="flex items-center gap-3 hover:opacity-80 transition-opacity">
          <div className="w-10 h-10 bg-white border-2 border-blue-300 rounded-xl flex items-center justify-center shadow-md">
