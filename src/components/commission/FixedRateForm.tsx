...
const FixedRateForm: React.FC<FixedRateFormProps> = ({ onCancel, onSave, initialData }) => {
  ...
  // Garante que o array de produtos contenha o produto do initialData, caso ele tenha sido removido/arquivado
  const allProducts = Array.from(new Set([...products, initialData?.product].filter(Boolean)));
