-- ============================================
-- SQL PARA ADICIONAR SENHA ADMINISTRATIVA
-- ============================================
...
DROP POLICY IF EXISTS "Users can view their own reset tokens" ON admin_password_resets;
DROP POLICY IF EXISTS "Users can create their own reset tokens" ON admin_password_resets;
DROP POLICY IF EXISTS "Users can update their own reset tokens" ON admin_password_resets;
...
-- FIM DO SQL
-- ============================================
-- Após executar, a senha administrativa estará disponível!
-- ============================================
